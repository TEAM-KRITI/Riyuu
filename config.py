...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TEAM-KRITI/Riyuu",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/badnaam_shyar")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+nlXLIaDSFhcwMTNl")
